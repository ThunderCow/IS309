...
procedure CREATE_COMMITMENT_PP (p_commitment_id     OUT INTEGER,    -- Output parameter
p_member_email      IN  VARCHAR,    -- Not NULL
p_opportunity_id    IN  VARCHAR,    -- Not NULL
p_start_date        IN  DATE,
p_end_date          IN  DATE);

procedure RECORD_HOURS_PP (p_member_email      IN  VARCHAR,    -- Not NULL
p_opportunity_id    IN  VARCHAR,    -- NOT NULL
p_hours             IN  NUMBER,     -- NOT NULL
p_volunteer_date    IN  DATE        -- NOT NULL
);

procedure APPROVE_HOURS_PP (p_member_email      IN VARCHAR,    -- Must not be NULL.
...
procedure SEARCH_OPPORTUNITIES_PP (p_member_email      IN VARCHAR      -- Must not be NULL
);
